...
<table border="1" class="table table-dark" width="100%">
   <thead>
       <tr>
           ...
           <th class="text-center" style="background-color: #8B008B">Current Stock</th>           <th class="text-center">Quantity</th>
...
<input type="hidden" name="category_id[]" value="{{ $details->category_id }}">
   ...
   <td class="text-center" style="background-color: #8B008B">{{ $details['product']['quantity'] }}</td>   <td class="text-center">{{ $details->selling_qty }}</td>
