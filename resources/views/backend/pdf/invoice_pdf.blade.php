                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="thick-line text-end">{{ $total_sum }} Dt</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="no-line"></td>
                                                        <td class="no-line"></td>
                                                        ...
                                                        <td class="no-line text-end">{{ $payment->discount_amount }} Dt</td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="no-line text-end">{{ $payment->paid_amount }} Dt</td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="no-line text-end">{{ $payment->due_amount }} Dt</td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="no-line text-end">
                                                            <h4 class="m-0">{{ $payment->total_amount }} Dt</h4>
                                                        </td>
                                                    </tr>
